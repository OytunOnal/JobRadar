import { analyzeFit, judgeQueueWhere, unjudgedWhere, verdictFields, FIT_PROMPT_VERSION } from "../../src/lib/llm/fit";
import { andWhere } from "../../src/lib/queue/pool";
...
import { levelBlocked, type SeniorityLevel } from "../../src/lib/scoring/seniority";
import { profile, seniorityFor } from "../../src/lib/user/profile";
